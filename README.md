...
I would like to inculcate all best principles learnt from this training like Reducing cyclomatic complexity so that it will help in writing test cases easy, code coverage can be improved and bugs can be easily detected through single responsibility approach & so on.
